...
export const briefing = {it:'CAPI, una nave ha attraccato senza autorizzazione. Il responsabile indossa una giacca rossa, controlla le casse e usa il telefono. Identificalo prima di agire. Due uomini armati e due lavoratori sono nell’area: non sono il tuo obiettivo. Docky è in posizione.',en:'CAPI, a ship has docked without authorization. The coordinator wears a red jacket, checks the crates and uses a phone. Identify him before acting. Two armed men and two workers are in the area: they are not your target. Docky is in position.'};
