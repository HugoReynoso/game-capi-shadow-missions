...
import {createMissionRuntime,type Commands,type GameHUD} from './runtime';
import {AimJoystick} from './AimJoystick';
import {MAGAZINE_SIZE,type MissionState,type MissionResult} from './rules';
...
const initial:GameHUD={targetHealth:null,time:90,ammo:MAGAZINE_SIZE,zoom:1,breath:0,scan:0,breathing:false,scanning:false,reloading:false,reloadSeconds:0,state:'LOADING' as MissionState,fps:0,distance:0,heading:270,models:false,remaining:1,muted:false,exposed:false};
